...
public class BanRepository {
    ...
    public List<BanResponse> getAll(){
        ...
        listB=session.createQuery("SELECT new com.example.OnTapDTO1s.response.BanResponse(ban.id,ban.ma,ban.ten,ban.soThich,ban.gioiTinh,ban.moiQuanHe.ma,ban.moiQuanHe.ten) " +
